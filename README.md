...
This will compile project and store the build artifacts in the `dist/` directory. By default, the production build optimizes application for performance and speed.
